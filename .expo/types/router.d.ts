...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/auth/` | `/auth/` | `/(auth)/auth` | `/(auth)/auth/sign-up` | `/auth/sign-up` | `/(tabs)/home/` | `/home/` | `/(tabs)/home` | `/(tabs)/itinerary/` | `/itinerary/` | `/(tabs)/itinerary` | `/(tabs)/matching/` | `/matching/` | `/(tabs)/matching` | `/(tabs)/profile/` | `/profile/` | `/(tabs)/profile` | `/modal` | `/onboarding`;
  // prettier-ignore
